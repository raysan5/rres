...
static unsigned int rresComputeHashId(const char *fileName);
...
// Compute rres data chunk hash id from filename
unsigned int rresComputeHashId(const char *fileName)
{
    unsigned int hash = 0;
